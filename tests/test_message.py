...
def test_control():
    ...
    tests = [
        (
            ...
            0x23,
            0x44,
            b"\xBC\x02\x01\x23\x44\x00\x00\x00\x00",
        ),
        (message.Function.InWaves, 0x01, 0x00, b"\xBC\x02\x02\x01\x00\x00\x00\x00\x00"),
        (
            message.Function.Sequential,
            0x00,
            0x08,
            b"\xBC\x02\x03\x00\x08\x00\x00\x00\x00",
        ),
        (message.Function.SloGlo, 0x64, 0x12, b"\xBC\x02\x04\x64\x12\x00\x00\x00\x00"),
        (message.Function.Chasing, 0x63, 0x64, b"\xBC\x02\x05\x63\x64\x00\x00\x00\x00"),
        (
            message.Function.SlowFade,
            0x19,
            0x55,
            b"\xBC\x02\x06\x19\x55\x00\x00\x00\x00",
        ),
        (message.Function.Twinkle, 0x37, 0x01, b"\xBC\x02\x07\x37\x01\x00\x00\x00\x00"),
        (message.Function.Steady, 0x45, 0x63, b"\xBC\x02\x08\x45\x63\x00\x00\x00\x00"),
        (
            message.Function.FlashAlternating,
            0x57,
            0x50,
            b"\xBC\x02\x09\x57\x50\x00\x00\x00\x00",
        ),
        (
            message.Function.FlashSynchronous,
            0x0F,
            0x28,
            b"\xBC\x02\x0A\x0F\x28\x00\x00\x00\x00",
        ),
    ]
